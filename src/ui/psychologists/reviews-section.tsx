...
export default function ReviewsSection({ reviews }: ReviewsSectionProps) {
  return (
    <ul className="mb-6 sm:mb-8 lg:mb-10">
      {reviews.map((review, index) => (
        <li key={index} className="mb-[15px] sm:mb-[20px] lg:mb-[25px]">
          <div className="flex gap-3">
            ...
            <div>
              <p className="leading-[125%] text-black mb-1">
                {review.reviewer}
              </p>
          ...
          <p className="font-normal leading-[125%] text-primary-base/50 mt-[10px] sm:mt-[14px] lg:mt-[18px]">
            {review.comment}
          </p>
        </li>
      ))}
